...
class HermesCLI:
    ...
    def _handle_reasoning_command(self, cmd: str):
        ...
        Usage:
            ...
            /reasoning <level>      Set reasoning effort (none, minimal, low, medium, high, xhigh, max, ultracode)
        ...
        if parsed is None:
            ...
            _cprint(f"  {_DIM}Valid levels: none, minimal, low, medium, high, xhigh, max, ultracode{_RST}")
