...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "minimax": 204800,
    # GLM
    # GLM-5.2 unlimited (via Devin/windsurf) supports 1M context (1,048,576).
    # The free tier without [1m] suffix = 202,752 tokens (~200K).
    # Since we route through glm-proxy (Devin backend = unlimited plan),
    # default to 1M for all glm-5.2/glm-5-2 variants.
    "glm-5.2[1m]": 1048576,
    "glm-5.2": 1048576,
    "glm-5-2": 1048576,
    "glm": 202752,
